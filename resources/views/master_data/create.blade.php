...
<div class="container mt-4">
    <h1 class="text-center mb-4">إضافة بيانات الماستر</h1>
    ...
    <form action="{{ route('master-data.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="claim_number" name="claim_number" value="{{ old('claim_number') }}" >
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="car_type" name="car_type" value="{{ old('car_type') }}" >
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="chassis_number" name="chassis_number" value="{{ old('chassis_number') }}" >
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="incoming" name="incoming" value="{{ old('incoming') }}" >
        </div>

        <div class="mb-3">
            <label for="dealer" class="form-label">التاجر</label>
            <input type="text" class="form-control" id="dealer" name="dealer" value="{{ old('dealer') }}" >
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="outgoing" name="outgoing" value="{{ old('outgoing') }}" >
        </div>

        <div class="mb-3">
            <label for="stock_balance" class="form-label">رصيد المخزون</label>
            <input type="number" class="form-control" id="stock_balance" name="stock_balance" value="{{ old('stock_balance') }}" >
        </div>

        <div class="mb-3">
            <label for="claim_balance" class="form-label">رصيد المطالبة</label>
            <input type="number" class="form-control" id="claim_balance" name="claim_balance" value="{{ old('claim_balance') }}" >
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="claim_count" name="claim_count" value="{{ old('claim_count') }}" >
        </div>

        <div class="mb-3">
            <label for="received_count" class="form-label">عدد المستلم</label>
            <input type="number" class="form-control" id="received_count" name="received_count" value="{{ old('received_count') }}" >
        </div>

        <div class="mb-3">
            <label for="claim_date" class="form-label">تاريخ المطالبة</label>
            <input type="date" class="form-control" id="claim_date" name="claim_date" value="{{ old('claim_date') }}" >
        </div>
